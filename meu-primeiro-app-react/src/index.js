...
const App = () => {
  const estilosBotao = {marginTop:12, paddingTop:8, paddingBottom:8, backgroundColor: 'blueviolet', color: 'white', border:'none', with:100, borderRadius:8};
  const textoRotulo = "Nome:"
  return <div style={{margin: 'auto', width: 768, backgroundColor: '#EEE', padding: 12, borderRadius: 8}}>

<label className = "rotulo" htmlFor="nome" id="nome" style={{display: 'block', marginBottom: 4}}>{textoRotulo}</label>
